  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        toast.success(`Welcome to Zembile, ${data.user.firstName}!`)
            ...
            <div className="flex items-start">
              <div className="flex items-center h-5">
                <input
                  ...
                  className="focus:ring-zembile-yellow h-4 w-4 text-zembile-yellow border-gray-300 rounded"
                />
              </div>
              <div className="ml-3 text-sm">
                <label htmlFor="agreeToTerms" className="text-gray-700">
                  I agree to the{' '}
                  <Link to="/terms" className="text-zembile-gray hover:text-gray-600 font-medium">
                    Terms of Service
                  </Link>{' '}
                  and{' '}
                  <Link to="/privacy" className="text-zembile-gray hover:text-gray-600 font-medium">
                    Privacy Policy
                  </Link>
                </label>
              </div>
